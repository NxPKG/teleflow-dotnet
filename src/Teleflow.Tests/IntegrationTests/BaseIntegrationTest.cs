...
using Teleflow.Extensions;
using Teleflow.Interfaces;
using Teleflow.Models.Subscribers;
...
using Step = Teleflow.Models.Workflows.Step.Step;
...
public abstract class BaseIntegrationTest : IDisposable
{
    ...
    protected ITeleflowClient Client => Get<ITeleflowClient>();
    ...
    {
        Register(services => services.RegisterTeleflowClients(_configurationRoot));
    }

    protected void RegisterExceptionHandler()
    {
        var defaultSerializerSettings = TeleflowClient.DefaultSerializerSettings;
        ...
        Register(services =>
            services
                .RegisterTeleflowClients(_configurationRoot, refitSettings)
                .RegisterTeleflowSync());
        ...
        where T : Integration
    {
        ...
        {
            Name = StringGenerator.LoremIpsum(4),
            ProviderId = providerId ?? "teleflow",

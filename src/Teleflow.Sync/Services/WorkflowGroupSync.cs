...
using Teleflow.Sync.Comparers;
using Teleflow.Sync.Models;
using Teleflow.Sync.Utils;

namespace Teleflow.Sync.Services;

public class WorkflowGroupSync :  ITeleflowSync<TemplateWorkflowGroup>
{

...
public class TopicSubscriber
{
    ...
    [JsonProperty("_topicId")] public string TopicId { get; set; }

    [JsonProperty("externalSubscriberId")] public string ExternalSubscriberId { get; set; }
    ...
    [JsonProperty("id")] public string DataId { get; set; }
}
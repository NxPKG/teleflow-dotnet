...
namespace Teleflow.DTO.Integrations;
...
public class Integration
{
    ...
    /// </summary>
    /// <remarks>
    ///     Until an enum strategy is implemented see https://github.com/nxpkg/teleflow/blob/next/libs/shared/src/consts/providers/provider.enum.ts
    /// </remarks>

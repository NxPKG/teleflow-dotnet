...
{
    /// <summary>
    ///     see https://docs.teleflow.khulnasoft.com/api/get-workflows/
    /// </summary>
    [Get("/workflows")]
    ...
    /// <summary>
    ///     see https://docs.teleflow.khulnasoft.com/api/get-workflow/
    /// </summary>
    [Get("/workflows/{id}")]
    public Task<TeleflowResponse<Workflow>> Get(string id);

    /// <summary>
    ///     https://docs.teleflow.khulnasoft.com/api/create-workflow/
    /// </summary>
    [Post("/workflows")]
    public Task<TeleflowResponse<Workflow>> Create([Body] WorkflowCreateData createWorkflowData);

    /// <summary>
    ///     see https://docs.teleflow.khulnasoft.com/api/update-workflow/
    /// </summary>
    [Put("/workflows/{id}")]
    ...
    /// <summary>
    ///     see https://docs.teleflow.khulnasoft.com/api/delete-workflow/
    /// </summary>
    [Delete("/workflows/{id}")]
    public Task<TeleflowResponse<bool>> Delete(string id);

    /// <summary>
    ///     see https://docs.teleflow.khulnasoft.com/api/update-workflow-status/
    /// </summary>

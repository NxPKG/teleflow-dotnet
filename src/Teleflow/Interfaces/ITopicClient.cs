...
public interface ITopicClient
{
    ...
    /// </param>
    /// <returns>
    ///     Returns a <see cref="TeleflowPaginatedResponse{T}" /> of type <see cref="Topic" />
    /// </returns>
    [Get("/topics")]
    public Task<TeleflowPaginatedResponse<Topic>> Get([Query] int page = 0);
    ...
    /// </example>
    [Post("/topics")]
    public Task<TeleflowResponse<Topic>> Create([Body] TopicCreateData data);
    ...
    /// <returns></returns>
    [Get("/topics/{topicKey}")]
    public Task<TeleflowResponse<Topic>> Get(string topicKey);
    ...
    public Task<TeleflowResponse<SucceedData>> AddSubscriber(string topicKey, TopicSubscriberCreateData data);
    ...
    public Task<TeleflowResponse<TopicSubscriber>> Verify(string topicKey, string subscriberId);
    ...
    public Task<TeleflowResponse<Topic>> Rename(string topicKey, [Body] TopicEditData data);
}